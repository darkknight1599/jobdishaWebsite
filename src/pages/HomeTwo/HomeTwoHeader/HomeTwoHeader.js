                  ...
                  <div className="container">
                     <div className="row align-items-center">
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6">
                           <div className="logo">
                              <NavLink to="/">
                                 {/* <img src="assets/img/logo/job_disha_chota-removebg-preview.png" alt="logo" /> */}
                                 <img src="assets/img/logo/job_disha_chota-removebg-preview.png" alt="logo" height='130px' width='150px' />
                                 {/* <img src="assets/img/logo/job_disha_chota-removebg-previeww.png" alt="logo" /> */}
                           ...
                           <div className="logo-gradient">
                              <NavLink to="/">
                                 ...
                                 <img src="assets/img/logo/job_disha_chota-removebg-preview.png" alt="logo" height='100px' width='100px' />
                                 {/* <img src="assets/img/logo/job_disha_chota-removebg-previeww.png" alt="logo" /> */}
                                 ...
                                 <nav id="mobile-menu">
                                    <ul>
                                       <li>
                                          ...
                                          {/* <li>
                                                <NavLink to="/homeTwo">Home Style 22</NavLink>
                                                <ul className="submenu">
                                                   <li><NavLink to="/home">Home Style 1</NavLink></li>

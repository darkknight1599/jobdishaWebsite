                                 ...
                                 <div className="footer__info">
                                    <ul>
                                       <li>
                                          ...
                                          <div className="text">
                                             <span>607,Vibrent Tower,Near Nissan Car Showroom, Geetabhawan, Indore.</span>
                                          </div>
                                       </li>
                                       <li>
                                          ...
                                          <div className="text theme-color ">
                                             <span><a href="mailto:info@jobdisha.com">info@jobdisha.com</a></span>
                                          </div>
                                       </li>
                                       <li>
                                          <div className="icon theme-color">
                                          ...
                                          <div className="text theme-color">
                                             <span><a href="tel:(+91)8319780703">(+91)8319780703</a></span>
                                          </div>
                                       </li>
                                    </ul>
                                 </div>
                     ...
                     <div className="row align-items-center">
                        <div className="col-xl-6 col-lg-6 col-md-6">
                           <div className="footer__copyright-text">
                              <p>Copyright © 2022 All Rights Reserved to  <Link to="/">Asparrow tech</Link></p>
                           </div>
                        </div>
                        <div className="col-xl-6 col-lg-6 col-md-6">
